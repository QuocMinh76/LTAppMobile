        ...
        builder.setView(dialogView)
                .setPositiveButton(eventId == null ? "Thêm" : "Sửa", (dialog, which) -> {
                    ...
                    if (eventId == null) {
                        ...
                        dbHelper.addEvent(eventName, description, datetime, location, false, "Khác", cateId, user_id); // Thêm userId thực tế
                    } else {
                        dbHelper.updateEvent(eventId, eventName, description, datetime, location, false, "Khác");
                    }
                    loadEventsForSelectedDate();
                })
